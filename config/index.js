export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx5165dbf50b95469f",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "d935997345a37f9a29c5aa7be0d83637",
  ...
  USERS: [
    {
      ...
      id: "oMRSa6NLT5IlG3ujLaEmWePep3Y4",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "cBu8AsPuxfLWlmZBi3MXwHH_e939X8nDxWYLJz_QRUA",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "肇庆",
  ...
  CALLBACK_TEMPLATE_ID: "cBu8AsPuxfLWlmZBi3MXwHH_e939X8nDxWYLJz_QRUA",
